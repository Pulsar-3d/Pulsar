...
#define CUSTOM_MACHINE_NAME "Pulsar X1"
...
// For the other hotends it is their distance from the extruder 0 hotend.
  #define HOTEND_OFFSET_X {0.0, 12.88} // (in mm) for each extruder, offset of the hotend on the X axis
  #define HOTEND_OFFSET_Y {0.0, 0.39}  // (in mm) for each extruder, offset of the hotend on the Y axis
